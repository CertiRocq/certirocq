...
| SBound_Prim1_c:
  ...
  (** Free variables of a composed context come from the outer context
      or the inner context, minus variables bound on the outer stem. *)
    ...
    eapply ctx_exp_mut with (P := fun C1 =>
                            ...
                            (P0 := fun F =>
                                     forall C,
                                       ...
                                       occurs_free_fundefs_ctx F :|:
                                       (occurs_free_ctx C \\ (names_in_fundefs_ctx F :|: bound_stem_fundefs_ctx F)));
      intros.
  ...
  (** Free variables of a context application come from the context
      or the plugged expression, minus variables bound on the stem. *)
    ...
    eapply ctx_exp_mut with (P := fun C =>
                            ...
                            (P0 := fun F =>
                                     forall e,
                                       ...
                                       occurs_free_fundefs_ctx F :|:
                                       (occurs_free e \\ (names_in_fundefs_ctx F :|: bound_stem_fundefs_ctx F)));
      intros.
    - simpl. normalize_occurs_free_ctx. normalize_bound_stem_ctx. sets.
