...
From CertiRocq.LambdaBox_to_LambdaANF Require Import common anf fuel_sem wf anf_convert_env anf_corresp anf_util.
...
Section Correct.
  ...
  Context (cenv_tgm_coh : anf_convert_env.cenv_tgm_coherence cenv tgm).
  ...
  Proof.
    intros Hget Hcon Hnth r cin cout Hleq Hbstep.
    do 3 eexists. split. econstructor 2. econstructor.
    exact Hget. exact Hcon. exact Hnth. exact Hbstep.
    split. simpl. unfold_all. lia.
    eapply preord_res_refl; tci.
  Qed.
  ...
  Proof.
    ...
    - (* c = S c': recursive case *)
      ...
      + apply find_tag_lt.
        * replace (S c' + N.to_nat n)%nat with (c' + N.to_nat (n + 1))%nat by lia.
          exact Hfind_tag.
        * intros <-. eapply dcon_to_tag_inj in Htg'. specialize (Htg' H2).
          injection Htg'. lia.
      + replace (S c' + N.to_nat n)%nat with (c' + N.to_nat (n + 1))%nat by lia.
        exact Hcvt_br.
      + exact HS_sub.
  ...
  Lemma anf_cvt_rel_branches_ind S ind brs n vnames y S3 pats : 
    anf_cvt_rel_branches func_tag default_tag tgm cmap S ind brs n vnames y S3 pats ->
    forall c c_tag, 
    ...
    Forall (fun '(tag, exp) => 
      exists info info', 
        ...
        cenv ! tag = Some info' /\ 
      ctor_ind_tag info = ctor_ind_tag info') pats.
  Proof.
    clear -cenv_tgm_coh.
    induction 1; constructor.
    - apply (cenv_tgm_coh _ _ _ _ _ H6 H).
    - eapply IHanf_cvt_rel_branches; eauto.
  Qed.
      ...
      intros v v' Heq Hrel'. subst r0.
        ...
        2:{ eapply preord_exp_trans; [tci | exact eq_fuel_idemp | | ].
            ...
            2:{ intros m.
                assert (IH1_val :
                  forall v0 v0',
                    fuel_sem.Val (Clos_v rho' na0 body0) = fuel_sem.Val v0 ->
                    anf_val_rel' v0 v0' ->
            ...
            2:{ intros m.
                ...
                assert (IH2_val :
                  forall v0 v0',
                    fuel_sem.Val v2 = fuel_sem.Val v0 ->
                    anf_val_rel' v0 v0' ->
      ...
      intros v v' Heq Hrel'. subst r0.
        ...
        2:{ eapply preord_exp_trans; [tci | exact eq_fuel_idemp | | ].
            ...
            2:{ intros m.
                assert (IH1_val :
                  forall v0 v0',
                    fuel_sem.Val (ClosFix_v rho' mfix0 idx0) = fuel_sem.Val v0 ->
                    anf_val_rel' v0 v0' ->
                    preord_exp cenv (anf_bound f1 t1) eq_fuel m
                      (C2 |[ Eletapp x x1 func_tag [x2] e_k ]|,
                       M.set x1 v0' rho)
      ...
      intros v v' Heq Hrel'. subst r0.
        ...
        2:{ eapply preord_exp_trans; [tci | exact eq_fuel_idemp | | ].
            ...
            2:{ intros m.
                assert (IH1_val :
                  forall v0 v0',
                    fuel_sem.Val v1 = fuel_sem.Val v0 ->
                    anf_val_rel' v0 v0' ->
                    preord_exp cenv (anf_bound f1 t1) eq_fuel m
            ...
            2:{ intros m.
                ...
                assert (IH2_val :
                  forall v0 v0',
                    fuel_sem.Val v = fuel_sem.Val v0 ->
                    anf_val_rel' v0 v0' ->
                    preord_exp cenv (anf_bound f2 t2) eq_fuel m
      ...
      intros v v' Heq Hrel'. subst r0.
        ...
        2:{ (* Simplify context: comp_ctx_f C1 (Eletapp_c ...) |[e_k]| → C1 |[Eletapp ... e_k]| *)
            ...
            2:{ (* === Step 1b: IH_mch through C1 === *)
                ...
                assert (IH_mch_val :
                  forall v0 v0',
                    fuel_sem.Val (Con_v (dcon_of_con ind c0) vs0) = fuel_sem.Val v0 ->
                    anf_val_rel' v0 v0' ->
                    preord_exp cenv (anf_bound f1 t1) eq_fuel m
            ...
            { eapply preord_exp_trans; [tci | exact eq_fuel_idemp | | ].
              2:{ intros m. eapply preord_exp_Ecase_red.
                  ...
                  - eapply anf_cvt_rel_branches_ind in Hcvt_brs; try eassumption.
                    clear -Hcvt_brs.
                    induction Hcvt_brs; try constructor.
                    destruct x. destruct H as [info [info' [h [h' heq]]]].
      ...
      intros v v' Heq Hrel'. injection Heq as <-.
        ...
        2:{ eapply preord_exp_trans; [tci | exact eq_fuel_idemp | | ].
            ...
            2:{ intros m.
                assert (IH_c_val :
                  forall v0 v0',
                    fuel_sem.Val (Con_v (dcon_of_con (proj_ind p0) 0) vs0) = fuel_sem.Val v0 ->
                    anf_val_rel' v0 v0' ->
                    preord_exp cenv (anf_bound f1 t1) eq_fuel m
                      (Eproj x_res
                         c_tag
    ...
    - intros rho0 e0 es0 v0 vs0 f0 fs0 t0 ts0
      ...
      2:{ eapply preord_exp_trans; [tci | exact eq_fuel_idemp | | ].
          ...
          2:{ intros m.
              assert (IH_e_val :
                forall v1 v1',
                  fuel_sem.Val v0 = fuel_sem.Val v1 ->
                  anf_val_rel' v1 v1' ->
