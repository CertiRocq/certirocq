...
Section Correct.
  ...
  Definition globals_terminate_prop :=
    forall k decl body,
      ...
      exists src_v f t,
        @CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.eval_env_fuel _ LambdaBox_resource_fuel LambdaBox_resource_trace
                       Σ box_dc [] body (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val src_v) f t.
  ...
  Let src_eval := @CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.eval_env_fuel nat LambdaBox_resource_fuel
                                 LambdaBox_resource_trace Σ box_dc.
  Let src_diverge := @CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.diverge nat LambdaBox_resource_fuel
                                        LambdaBox_resource_trace Σ box_dc.
  Let src_not_stuck := @CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.not_stuck nat LambdaBox_resource_fuel
                                            LambdaBox_resource_trace Σ box_dc.
  Let src_diverge_not_stuck := @CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.diverge_not_stuck nat LambdaBox_resource_fuel
                                                          LambdaBox_resource_trace Σ box_dc.
  ...
  Lemma eval_fuel_many_nth rho es vs f t k e v :
    @CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.eval_fuel_many _ LambdaBox_resource_fuel LambdaBox_resource_trace
                    Σ box_dc rho es vs f t ->
    nth_error es k = Some e ->
    nth_error vs k = Some v ->
    exists f_k t_k, src_eval rho e (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val v) f_k t_k.
  Proof.
  ...
  Lemma global_env_rel_set D rho x w :
    ...
    (forall k, D k -> lookup_const cmap k = Some x ->
      ...
      decl.(EAst.cst_body) = Some body ->
      forall src_v f_s t_s, src_eval [] body (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val src_v) f_s t_s ->
      anf_val_rel' src_v w) ->
    global_env_rel' D (M.set x w rho).
  Proof.
  ...
  Lemma eval_val_det rho0 e0 v1 v2 f1 t1 f2 t2 :
    src_eval rho0 e0 (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val v1) f1 t1 ->
    src_eval rho0 e0 (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val v2) f2 t2 ->
    v1 = v2.
  Proof. apply CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.eval_val_det. Qed.
  ...
  Lemma eval_preserves_wf
    ...
    src_eval rho0 e0 (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val v0) f0 t0 ->
  ...
  Lemma cmap_consistent_extend vn rho x1 v1 :
    ...
    (forall k decl body,
      ...
      declared_constant Σ k decl ->
      decl.(EAst.cst_body) = Some body ->
      exists f t, src_eval [] body (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val v1) f t) ->
  ...
  Lemma anf_cvt_rel_var_lookup_and_cmap_eval :
    forall rho e r f t,
      ...
      forall v, r = CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val v ->
      forall S vn S' C x,
  ...
  Proof.
    pose (Pcombined := fun (rho : list CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.value) (e : EAst.term)
  ...
  Definition anf_cvt_correct_exp
             (vs : CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.env) (e : EAst.term)
             (r : CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.result) (f t : nat) :=
    forall rho vnames C x S S' i,
      ...
      forall e_k,
        ...
        (forall v v', r = CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val v -> anf_val_rel' v v' ->
  ...
  Proof.
      ...
      intros v v' Heq Hrel'. subst r0.
        ...
        2:{ eapply preord_exp_trans; [tci | exact eq_fuel_idemp | | ].
            ...
            2:{ intros m.
                assert (IH1_val :
                  forall v0 v0',
                    CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val (Clos_v rho' na0 body0) = CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val v0 ->
                    anf_val_rel' v0 v0' ->
                    preord_exp cenv (anf_bound f1 t1) eq_fuel m
                      (C2 |[ Eletapp x x1 func_tag [x2] e_k ]|,
                       M.set x1 v0' rho)
                      (C1 |[ C2 |[ Eletapp x x1 func_tag [x2] e_k ]| ]|, rho)).
                { eapply (IH1 rho vnames C1 x1 S S2 m).
                  - exact Hwf.
                  - exact (proj1 (wellformed_tApp _ _ _ Hwfe)).
                  - exact Hcons.
                  - exact Hcmap.
            ...
            2:{ intros m.
                ...
                assert (IH2_val :
                  forall v0 v0',
                    CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val v2 = CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val v0 ->
                    anf_val_rel' v0 v0' ->
                    preord_exp cenv (anf_bound f2 t2) eq_fuel m
                      (Eletapp x x1 func_tag [x2] e_k,
                       M.set x2 v0' (M.set x1 v1' rho))
                      (C2 |[ Eletapp x x1 func_tag [x2] e_k ]|,
                       M.set x1 v1' rho)).
                { eapply (IH2 (M.set x1 v1' rho) vnames C2 x2 S2 S3 m).
                  - exact Hwf.
                  - exact (proj2 (wellformed_tApp _ _ _ Hwfe)).
                  - exact Hcons.
                  - exact Hcmap.
                  ...
                  - assert (Hglob_e2 : global_env_rel' (kn_deps e2) rho).
                    ...
                    assert (Heval_g' : exists fg tg,
                      src_eval [] body_g (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val (Clos_v rho' na0 body0)) fg tg).
                    { eapply anf_cvt_cmap_eval;
            ...
            assert (IH3_val :
              forall v0 v'0, CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val v = CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val v0 ->
               anf_val_rel' v0 v'0 ->
              ...
              { destruct (In_dec Pos.eq_dec x1 vnames) as [Hin_vn | Hni_vn].
                ...
                - (* x1 ∉ FromList vnames: from global_env_rel' + cmap *)
                  ...
                  assert (Heval1_cmap : exists f_c t_c,
                    src_eval [] body_g (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val (Clos_v rho' na0 body0)) f_c t_c).
                  { eapply anf_cvt_cmap_eval;
                      [exact Heval1 | exact Hcvt_e1 | exact Hdis | exact Hdis_cmap
                  ...
                  * (* x2 ∈ cmap_vars: case split on x2 ∈ FromList vnames *)
                    ...
                    -- (* x2 not in FromList: use global_env_rel' *)
                       ...
                       assert (Heval2_body : exists f_c t_c,
                         src_eval [] body_c (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val v2) f_c t_c).
                       { eapply anf_cvt_cmap_eval;
                    ...
                    -- (* x1 ∈ cmap_vars: case split on x1 ∈ FromList vnames *)
                       ...
                       ++ (* x1 not in FromList: use global_env_rel' *)
                          ...
                          assert (Heval1_body : exists f_c1 t_c1,
                            src_eval [] body_c1 (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val (Clos_v rho' na0 body0)) f_c1 t_c1).
                          { eapply anf_cvt_cmap_eval;
                              [exact Heval1 | exact Hcvt_e1 | exact Hdis | exact Hdis_cmap
    ...
    - intros e1 e2 v rho0 f1 f2 t1 t2 Heval1 IH1 Heval2 IH2.
      unfold anf_cvt_correct_exp_step.
      intros rho vnames C x S S' i Hwf Hwfe Hcons Hcmap Hdis Hdis_cmap Henv Hglob Hrel e_k Hdis_ek.
      intros v0 v' Heq Hrel'. congruence.
      ...
      intros v v' Heq Hrel'. subst r0.
        ...
        2:{ eapply preord_exp_trans; [tci | exact eq_fuel_idemp | | ].
            ...
            2:{ intros m.
                assert (IH1_val :
                  forall v0 v0',
                    CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val (ClosFix_v rho' mfix0 idx0) = CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val v0 ->
                    anf_val_rel' v0 v0' ->
                    preord_exp cenv (anf_bound f1 t1) eq_fuel m
                      (C2 |[ Eletapp x x1 func_tag [x2] e_k ]|,
                       M.set x1 v0' rho)
            ...
            2:{ intros m.
                ...
                assert (IH2_val :
                  forall v0 v0',
                    ...
                    preord_exp cenv (anf_bound f2 t2) eq_fuel m
                      (Eletapp x x1 func_tag [x2] e_k,
                       M.set x2 v0' (M.set x1 (Vfun rho1 Bs f0) rho))
                      (C2 |[ Eletapp x x1 func_tag [x2] e_k ]|,
                       M.set x1 (Vfun rho1 Bs f0) rho)).
                { eapply (IH2 (M.set x1 (Vfun rho1 Bs f0) rho) vnames C2 x2 S2 S3 m).
                  - exact Hwf.
                  - exact (proj2 (wellformed_tApp _ _ _ Hwfe)).
                  - exact Hcons.
                  - exact Hcmap.
                  ...
                  - assert (Hglob_e2 : global_env_rel' (kn_deps e2) rho).
                    ...
                    intros k_g _ Hlk_g decl_g body_g Hdecl_g Hbody_g src_vg f_g t_g Heval_g.
                    assert (Heval_g' : exists fg tg,
                      src_eval [] body_g (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val (ClosFix_v rho' mfix0 idx0)) fg tg).
                    { eapply anf_cvt_cmap_eval;
                        [exact Heval1 | exact Hcvt_e1 | exact Hdis | exact Hdis_cmap
                        | exact Hcons | exact Hcmap | exact Hlk_g | exact Hdecl_g | exact Hbody_g]. }
                    destruct Heval_g' as [fg [tg Heval_g']].
              ...
              { destruct (In_dec Pos.eq_dec x1 vnames) as [Hin_vn | Hni_vn].
                ...
                - destruct (anf_cvt_result_in_consumed _ _ _ _ _ _ Hcvt_e1)
                  ...
                  + destruct (anf_cvt_cmap_result_in_deps _ _ _ _ _ _ Hcvt_e1 Hin1
                    ...
                    exists v_rho. split; [exact Hget_g |].
                    assert (Heval1_cmap : exists f_c t_c,
                      src_eval [] body_g (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val (ClosFix_v rho' mfix0 idx0)) f_c t_c).
                    { eapply anf_cvt_cmap_eval;
                        [exact Heval1 | exact Hcvt_e1 | exact Hdis | exact Hdis_cmap
                        | exact Hcons | exact Hcmap | exact Hlk1 | exact Hdecl_g | exact Hbody_g]. }
                    destruct Heval1_cmap as [f_c1 [t_c1 Hev1]].
                    ...
                    * (* y = x1: same as App but with ClosFix_v *)
                      ...
                      -- (* x1 ∈ cmap_vars *)
                         ...
                         ++ eexists. split.
                            ...
                            assert (anf_vc1 = w) by congruence. subst anf_vc1.
                            assert (Heval1_body : exists f_c1 t_c1,
                              src_eval [] body_c1 (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val (ClosFix_v rho' mfix0 idx0)) f_c1 t_c1).
                            { eapply anf_cvt_cmap_eval;
                                [exact Heval1 | exact Hcvt_e1 | exact Hdis | exact Hdis_cmap
                                | exact Hcons | exact Hcmap | exact Hlk_c1 | exact Hdecl_c1 | exact Hbody_c1]. }
                            destruct Heval1_body as [f_c1' [t_c1' Heval1_c1]].
      ...
      intros v v' Heq Hrel'. subst r0.
        ...
        2:{ eapply preord_exp_trans; [tci | exact eq_fuel_idemp | | ].
            ...
            2:{ intros m.
                assert (IH1_val :
                  forall v0 v0',
                    CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val v1 = CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val v0 ->
                    anf_val_rel' v0 v0' ->
                    preord_exp cenv (anf_bound f1 t1) eq_fuel m
                      (C2 |[ e_k ]|, M.set x1 v0' rho)
                      (C1 |[ C2 |[ e_k ]| ]|, rho)).
                { eapply IH1.
                  - exact Hwf.
                  - exact (proj1 (wellformed_tLetIn _ _ _ _ Hwfe)).
            ...
            2:{ intros m.
                ...
                assert (IH2_val :
                  forall v0 v0',
                    CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val v = CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val v0 ->
                    anf_val_rel' v0 v0' ->
                    preord_exp cenv (anf_bound f2 t2) eq_fuel m
                      (e_k, M.set x v0' (M.set x1 v1' rho))
                      (C2 |[ e_k ]|, M.set x1 v1' rho)).
                { eapply IH2.
                   ...
                   - (* x1 ∈ cmap_vars: case split on x1 ∈ FromList vnames *)
                     ...
                     + (* x1 not in FromList: use global_env_rel' *)
                       ...
                       assert (Heval_cmap : exists f_c t_c,
                         src_eval [] bx (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val v1) f_c t_c).
                       { eapply anf_cvt_cmap_eval;
                           [exact Heval1 | exact Hcvt_b | exact Hdis | exact Hdis_cmap
    ...
    - intros ind c args vs0 rho0 dc fs ts
      ...
      intros v v' Heq Hrel'. injection Heq as <-.
        ...
        remember (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Con_v (dcon_of_con ind c) vs_src) as cv.
      ...
      intros v v' Heq Hrel'. subst r0.
        ...
        2:{ (* Simplify context: comp_ctx_f C1 (Eletapp_c ...) |[e_k]| → C1 |[Eletapp ... e_k]| *)
            ...
            2:{ (* === Step 1b: IH_mch through C1 === *)
                ...
                assert (IH_mch_val :
                  forall v0 v0',
                    CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val (Con_v (dcon_of_con ind c0) vs0) = CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val v0 ->
                    anf_val_rel' v0 v0' ->
                    preord_exp cenv (anf_bound f1 t1) eq_fuel m
                      (Eletapp x f0 func_tag [x1] e_k, M.set x1 v0' rho_efun)
                      (C1 |[ Eletapp x f0 func_tag [x1] e_k ]|, rho_efun)).
                { eapply (IH_mch rho_efun vnames C1 x1
                           (S \\ [set f0] \\ [set y]) S2 m).
                - exact Hwf.
                - exact Hwfe_mch.
                - exact Hcons.
            ...
            { (* Assert Disjoint for Ehalt r_br before edestruct to resolve evar *)
              ...
              assert (IH_body_val' :
                forall v0 v0',
                  CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val v = CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val v0 ->
                  anf_val_rel' v0 v0' ->
                  preord_exp cenv (anf_bound f2 t2) eq_fuel (i + 1)
                    (Ehalt r_br, M.set r_br v0' rho_proj)
                    (C_br |[ Ehalt r_br ]|, rho_proj)).
              { eapply IH_body.
                 ...
                 { destruct (In_dec Pos.eq_dec x1 vnames) as [Hin_vn | Hni_vn].
                   ...
                   - destruct (anf_cvt_result_in_consumed _ _ _ _ _ _ Hcvt_mch)
                     ...
                     + (* x1 ∈ cmap_vars: use global_env_rel' *)
                       ...
                       assert (Heval_cmap : exists f_c t_c,
                         src_eval [] body_g (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val (Con_v (dcon_of_con ind c0) vs0)) f_c t_c).
                       { eapply anf_cvt_cmap_eval;
      ...
      intros v v' Heq Hrel'. injection Heq as <-.
        ...
        2:{ eapply preord_exp_trans; [tci | exact eq_fuel_idemp | | ].
            ...
            2:{ intros m.
                assert (IH_c_val :
                  forall v0 v0',
                    CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val (Con_v (dcon_of_con (proj_ind p0) 0) vs0) = CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val v0 ->
                    anf_val_rel' v0 v0' ->
                    preord_exp cenv (anf_bound f1 t1) eq_fuel m
                      (Eproj x_res
                 ...
                 { destruct (anf_cvt_result_in_consumed _ _ _ _ _ _ Hcvt_c)
                   ...
                   - (* x ∈ cmap_vars *)
                     ...
                     + destruct (anf_cvt_cmap_result_in_deps _ _ _ _ _ _ Hcvt_c Hin_cm
                       ...
                       assert (Heval_cmap : exists f_c t_c,
                         src_eval [] bx
                           (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val (Con_v (dcon_of_con (proj_ind p0) 0) vs0)) f_c t_c).
                       { eapply anf_cvt_cmap_eval;
                           [exact Heval_c | exact Hcvt_c | exact Hdis | exact Hdis_cmap
    ...
    - intros rho0 e0 es0 v0 vs0 f0 fs0 t0 ts0
      ...
      2:{ eapply preord_exp_trans; [tci | exact eq_fuel_idemp | | ].
          ...
          2:{ intros m.
              assert (IH_e_val :
                forall v1 v1',
                  CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val v0 = CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val v1 ->
                  anf_val_rel' v1 v1' ->
                  preord_exp cenv (anf_bound f0 t0) eq_fuel m
                    (C2 |[ e_k ]|, M.set x1 v1' rho)
                    (C1 |[ C2 |[ e_k ]| ]|, rho)).
              { eapply (IH_e rho vnames C1 x1 S S2 m).
              - exact Hwf.
              - match goal with
