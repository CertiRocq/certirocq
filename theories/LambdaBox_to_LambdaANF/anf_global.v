...
Section ValRelWeaken.
  ...
  Lemma forall2_val_rel_weaken (Q : CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.value -> Prop) vs :
    Forall (fun v => Q v ->
  ...
  Lemma env_rel_val_rel_weaken (Q : CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.value -> Prop) vs :
    Forall (fun v => Q v ->
                     forall v', anf_val_rel_full v v' -> anf_val_rel_part v v') vs ->
    forall names rho,
  ...
  Proof.
    ...
    exact (proj1 (@CertiRocq.LambdaBox_to_LambdaANF.wf.eval_env_fuel_restrict _ _ Hf_src Ht_src Σ_full box_dc Σ_tail
                    [] body (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val v_i) f0 t0 Hwf_tail Hext
  ...
  Proof.
    ...
    (* ============ BASE: Σ0 = [] ============ *)
    - intros Hext0 v.
      induction v using CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.value_ind';
        intros Hwf v' Hrel.
      + (* Con_v *)
    ...
    - intros Hext0.
      ...
      + (* Clos_v *)
        ...
        * (* global_env_rel' part — use OUTER IH *)
          ...
          assert (Heval_full : @CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.eval_env_fuel _ Hf_src Ht_src Σ_full box_dc []
                                body (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val src_v) f0 t0).
          { exact (@CertiRocq.LambdaBox_to_LambdaANF.wf.eval_env_fuel_extends _ Hf_src Ht_src Σ_full box_dc
...
Section GlobalBindingsCorrect.
  ...
  Let src_eval := @CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.eval_env_fuel nat Hf_src Ht_src Σ box_dc.
  ...
  Local Notation eval_at Σ0 :=
    (@CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.eval_env_fuel nat Hf_src Ht_src Σ0 box_dc).
  ...
  Proof.
    ...
    { intros k decl body0 Hdecl Hbody0.
      ...
      pose proof (proj1 (@CertiRocq.LambdaBox_to_LambdaANF.wf.eval_env_fuel_restrict _ _ Hf_src Ht_src
                           Σ box_dc Σ_proc
                           [] body0 (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val src_v0) f0 t0
    ...
    { intros k decl body0 src_v0 f0 t0 Hdecl Hbody0 Heval_proc.
      ...
      pose proof (@CertiRocq.LambdaBox_to_LambdaANF.wf.eval_env_fuel_extends _ Hf_src Ht_src
                    Σ box_dc Σ_proc
                    [] body0 (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val src_v0) f0 t0
    ...
    pose proof (@anf_cvt_correct
                  ...
                  [] body (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val src_v) f t Heval)
      as Hcorrect.
  ...
  Proof.
    ...
    pose proof (proj1 (@CertiRocq.LambdaBox_to_LambdaANF.wf.eval_env_fuel_restrict _ _ Hf_src Ht_src
                         ...
                         [] body1 (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val src_v) f t
  ...
  Proof.
    ...
    - simpl in HΣ_eq.
      ...
      { intros k0 v0 Hd Hlk_cm0.
        ...
        assert (Heval_full :
          @CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.eval_env_fuel _ Hf_src Ht_src Σ box_dc []
            body_full (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val src_v1) f1 t1).
      ...
      { pose proof (proj1 (@CertiRocq.LambdaBox_to_LambdaANF.wf.eval_env_fuel_restrict _ _ Hf_src Ht_src
                           Σ box_dc Σ_proc
                           [] body (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val src_v) f t
                           Hwf_proc Hext_proc ltac:(constructor)
      ...
      { intros k1 k2 x decl1 body1 decl2 body2 src_v0 f0 t0
        ...
        - apply eq_kername_bool_eq in Hk1. subst k1.
          ...
          pose proof (proj1 (@CertiRocq.LambdaBox_to_LambdaANF.wf.eval_env_fuel_restrict _ _ Hf_src Ht_src
                               ((k, EAst.ConstantDecl {| EAst.cst_body := Some body |}) :: Σ_proc)
                               box_dc Σ_proc
                               [] body (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val src_v0) f0 t0
          ...
          destruct (@anf_cvt_cmap_eval func_tag default_tag tgm cm0 Σ_proc box_dc
            ...
            as [f' [t' Heval2_tail]].
          exists f', t'. exact (@CertiRocq.LambdaBox_to_LambdaANF.wf.eval_env_fuel_extends _ Hf_src Ht_src
                                 ((k, EAst.ConstantDecl {| EAst.cst_body := Some body |}) :: Σ_proc)
                                 box_dc Σ_proc [] body2 (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val src_v0) f' t'
        ...
        - apply eq_kername_bool_eq in Hk2. subst k2.
          ...
          pose proof (proj1 (@CertiRocq.LambdaBox_to_LambdaANF.wf.eval_env_fuel_restrict _ _ Hf_src Ht_src
                               ((k, EAst.ConstantDecl {| EAst.cst_body := Some body |}) :: Σ_proc)
                               box_dc Σ_proc
                               [] body1 (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val src_v0) f0 t0
                               Hwf_proc Hext_proc_small ltac:(constructor)
                               Hwf_body1_tail Heval1))
            as Heval1_tail.
          destruct (Hglob_term k {| EAst.cst_body := Some body |} body Hdecl_cur_full eq_refl)
          ...
          pose proof (proj1 (@CertiRocq.LambdaBox_to_LambdaANF.wf.eval_env_fuel_restrict _ _ Hf_src Ht_src
                               Σ box_dc Σ_proc
                               [] body (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val src_v_new) f_new t_new
                               Hwf_proc Hext_proc ltac:(constructor)
          ...
          subst src_v_new.
          exists f_new, t_new. exact (@CertiRocq.LambdaBox_to_LambdaANF.wf.eval_env_fuel_extends _ Hf_src Ht_src
                                 ((k, EAst.ConstantDecl {| EAst.cst_body := Some body |}) :: Σ_proc)
                                 box_dc Σ_proc [] body (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val src_v0) f_new t_new
    ...
    - simpl in HΣ_eq.
      ...
      { intros k1 k2 x decl1 body1 decl2 body2 src_v f t
        ...
        - apply eq_kername_bool_eq in Hk1. subst k1.
          ...
          exists f', t'. exact (@CertiRocq.LambdaBox_to_LambdaANF.wf.eval_env_fuel_extends _ Hf_src Ht_src
                                 ((k, EAst.ConstantDecl {| EAst.cst_body := Some body |}) :: Σ_proc)
                                 box_dc Σ_proc [] body2 (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val src_v) f' t'
                                 Hext_proc_small Heval2_tail).
        - apply eq_kername_bool_eq in Hk2. subst k2.
          injection Hlk2 as <-.
          unfold declared_constant in Hdecl2.
          ...
          subst src_v_new.
          exists f_new, t_new.
          exact (@CertiRocq.LambdaBox_to_LambdaANF.wf.eval_env_fuel_extends _ Hf_src Ht_src
                   ((k, EAst.ConstantDecl {| EAst.cst_body := Some body |}) :: Σ_proc)
                   box_dc Σ_proc [] body (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val src_v) f_new t_new
                   Hext_proc_small Heval_new_tail).
        - assert (Hlk1_tail : lookup_const cm0 k1 = Some x) by exact Hlk1.
          assert (Hlk2_tail : lookup_const cm0 k2 = Some x) by exact Hlk2.
          exact (Hcoh_old1 _ _ _ _ _ _ _ _ _ _ Hlk1_tail Hlk2_tail
