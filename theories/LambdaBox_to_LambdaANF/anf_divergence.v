...
Section Divergence.
  ...
  Let global_env_rel' :=
    @global_env_rel func_tag default_tag tgm cmap
                    ...
                    Σ box_dc.
  Let src_eval :=
    @CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.eval_env_fuel nat
                   (LambdaBox_resource_fuel default_tag tgm box_dc box_tag)
                   (LambdaBox_resource_trace default_tag tgm box_dc box_tag)
                   Σ box_dc.
  ...
  Let src_diverge :=
    @CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.diverge nat
                      (LambdaBox_resource_fuel default_tag tgm box_dc box_tag)
                      (LambdaBox_resource_trace default_tag tgm box_dc box_tag)
                      Σ box_dc.
  Let src_not_stuck :=
    @CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.not_stuck nat
                        (LambdaBox_resource_fuel default_tag tgm box_dc box_tag)
                        (LambdaBox_resource_trace default_tag tgm box_dc box_tag)
                        Σ box_dc.
  Let eq_fuel_compat' :=
  ...
  Definition anf_cvt_correct_exps'
             (vs_env : CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.env) (es : list EAst.term)
             (vs1 : list CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.value) (f t : nat) :=
  ...
  Lemma eval_val_exact_det rho e v1 v2 f1 t1 f2 t2 :
    src_eval rho e (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val v1) f1 t1 ->
    src_eval rho e (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val v2) f2 t2 ->
    v1 = v2 /\ f1 = f2 /\ t1 = t2.
  Proof. apply CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.eval_val_exact_det. Qed.

  Lemma src_eval_val_gt_oot rho0 e0 v0 f_val t_val :
    src_eval rho0 e0 (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val v0) f_val t_val ->
    forall f_oot t_oot,
      src_eval rho0 e0 CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.OOT f_oot t_oot ->
      f_oot < f_val.
  Proof.
    intros Hval.
    set (Pstep := fun (rho : CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.env) (e : EAst.term)
                      (r : CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.result) (f : nat) (t : nat) =>
      match r with
      | CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val _ =>
        forall f_oot t_oot,
          @eval_env_step _ src_fuel_res src_trace_res
                         Σ box_dc rho e CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.OOT f_oot t_oot ->
          f_oot < f
      | CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.OOT => True
      end).
    set (Pmany := fun (rho : CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.env) (es : list EAst.term)
                      (vs : list CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.value) (fs : nat) (ts : nat) =>
      forall args_done e args_rest vs_done fs' f_oot t_oot ts',
        es = args_done ++ e :: args_rest ->
        @CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.eval_fuel_many _ src_fuel_res src_trace_res
                        Σ box_dc rho args_done vs_done fs' ts' ->
        src_eval rho e CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.OOT f_oot t_oot ->
        fs' + f_oot < fs).
    set (Pfuel := fun (rho : CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.env) (e : EAst.term)
                      (r : CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.result) (f : nat) (t : nat) =>
      match r with
      | CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val _ =>
        forall f_oot t_oot,
    ...
    enough (Haux : Pfuel rho0 e0 (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val v0) f_val t_val) by exact Haux.
    eapply (@CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.eval_env_fuel_ind'
    ...
    - intros n rho v Hnth f_oot t_oot Hoot.
      ...
      remember CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.OOT as r_oot in Hoot.
  ...
  Lemma anf_cvt_rel_var_lookup rho e v f t :
    src_eval rho e (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val v) f t ->
    forall S vn S' C x i,
  ...
  Lemma anf_cvt_cmap_eval rho e v f t :
    ...
    forall S vn S' C x k decl body,
      ...
      declared_constant Σ k decl ->
      decl.(EAst.cst_body) = Some body ->
      exists f' t', src_eval [] body (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val v) f' t'.
  Proof.
  ...
  Lemma src_eval_app_val_fun rho e1 e2 v_app f t :
    src_eval rho (EAst.tApp e1 e2) (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val v_app) f t ->
    exists v1 f1 t1,
      src_eval rho e1 (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val v1) f1 t1.
  Proof.
    intros Happ.
    inversion Happ; subst; try discriminate.
    remember (EAst.tApp e1 e2) as e_app in H.
    remember (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val v_app) as r_app in H.
  ...
  Lemma src_eval_app_oot_fun_if_no_fun_val rho e1 e2 f t :
    (forall src_v f' t', ~ src_eval rho e1 (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val src_v) f' t') ->
    src_eval rho (EAst.tApp e1 e2) CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.OOT (Datatypes.S f) t ->
    exists t1, src_eval rho e1 CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.OOT f t1.
  Proof.
  ...
  Proof.
    intros Hns.
      destruct (classic (exists src_v f t, src_eval rho e1 (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val src_v) f t))
      as [Hval | Hnoval].
    - left. exact Hval.
    - right. intros f.
  ...
  Lemma src_eval_app_val_arg rho e1 e2 v_app f t :
    src_eval rho (EAst.tApp e1 e2) (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val v_app) f t ->
    exists v2 f2 t2,
      src_eval rho e2 (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val v2) f2 t2.
  Proof.
    intros Happ.
    inversion Happ; subst; try discriminate.
    remember (EAst.tApp e1 e2) as e_app in H.
  ...
  Lemma src_eval_app_oot_arg_if_fun_val_no_arg_val rho e1 e2 v1 f1 t1 f t :
    src_eval rho e1 (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val v1) f1 t1 ->
    (forall src_v f' t', ~ src_eval rho e2 (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val src_v) f' t') ->
    src_eval rho (EAst.tApp e1 e2) CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.OOT (f1 + f + 1) t ->
    exists t2, src_eval rho e2 CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.OOT f t2.
  Proof.
  ...
  Proof.
    intros He1 Hns.
    destruct (classic (exists src_v f t, src_eval rho e2 (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val src_v) f t))
      as [Hval | Hnoval].
    - left. exact Hval.
    - right. intros f.
      destruct Hns as [Happ_val | Hdiv_app].
  ...
  Lemma src_eval_lt_OOT_any rho0 e0 r0 f0 t0 :
    ...
    forall f', f' < f0 ->
    exists t', src_eval rho0 e0 CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.OOT f' t'.
  Proof.
    intros Heval.
    set (Pstep := fun (rho : CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.env) (e : EAst.term)
                      (r : CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.result) (f : nat) (t : nat) =>
      ...
      exists t', @eval_env_step _ src_fuel_res src_trace_res
                                 Σ box_dc rho e CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.OOT f' t').
    set (Pmany := fun (rho : CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.env) (es : list EAst.term)
                      (vs : list CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.value) (fs : nat) (ts : nat) =>
      forall f',
        f' < fs ->
    ...
    set (Pfuel := fun (rho : CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.env) (e : EAst.term)
                      (r : CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.result) (f : nat) (t : nat) =>
      forall f', f' < f ->
      exists t', src_eval rho e CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.OOT f' t').
    ...
    - intros e1 e2 body v2 r na rho rho' f1 f2 f3 t1 t2 t3
      ...
      + destruct (IH1 _ Hlt1) as [t_oot Hoot].
        exists t_oot. now eapply CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.eval_App_step_OOT1.
      + assert (Hlt23 : f' - f1 < f2 + f3) by lia.
        ...
        * destruct (IH2 _ Hlt2) as [t_oot Hoot].
          ...
          rewrite Heqf.
          exact (@CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.eval_App_step_OOT2
                   nat src_fuel_res src_trace_res
                   Σ box_dc e1 e2 (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Clos_v rho' na body) rho
        ...
        * assert (Hlt3 : f' - f1 - f2 < f3) by lia.
          ...
          rewrite Heqf.
          exact (@CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.eval_App_step
                   nat src_fuel_res src_trace_res
                   Σ box_dc e1 e2 body v2 CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.OOT na rho rho'
    ...
    - intros e1 e2 body rho rho' rho'' idx na mfix v2 r f1 f2 f3 t1 t2 t3
      ...
      + assert (Hlt23 : f' - f1 < f2 + f3) by lia.
        ...
        * destruct (IH2 _ Hlt2) as [t_oot Hoot].
          ...
          exact (@CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.eval_App_step_OOT2
                   nat src_fuel_res src_trace_res
                   Σ box_dc e1 e2 (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.ClosFix_v rho' mfix idx) rho
                   f1 (f' - f1) t1 t_oot He1 Hoot).
        * assert (Hlt3 : f' - f1 - f2 < f3) by lia.
          destruct (IH3 _ Hlt3) as [t_oot Hoot].
          exists (t1 + t2 + t_oot).
          assert (Heqf : f' = (f1 + f2 + (f' - f1 - f2))) by lia.
          rewrite Heqf.
          exact (@CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.eval_FixApp_step
                   nat src_fuel_res src_trace_res
                   Σ box_dc e1 e2 body rho rho' rho'' idx na mfix v2
                   CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.OOT f1 f2 (f' - f1 - f2) t1 t2 t_oot
                   He1 Hfix Hrec He2 Hoot).
    - intros na b t v1 r rho f1 f2 t1 t2
             Heb IHb Het IHt f' Hlt.
      destruct (Nat.lt_ge_cases f' f1) as [Hlt1 | Hge1].
      + destruct (IHb _ Hlt1) as [t_oot Hoot].
        exists t_oot. now eapply CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.eval_LetIn_step_OOT.
      + assert (Hlt2 : f' - f1 < f2) by lia.
        destruct (IHt _ Hlt2) as [t_oot Hoot].
        exists (t1 + t_oot).
        assert (Heqf : f' = (f1 + (f' - f1))) by lia.
        rewrite Heqf.
        exact (@CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.eval_LetIn_step
                 nat src_fuel_res src_trace_res
                 Σ box_dc na b t v1 CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.OOT rho f1 (f' - f1) t1 t_oot
                 Heb Hoot).
    ...
    - intros ind c args vs rho dc fs ts Hdc Hmany IHmany f' Hlt.
      ...
      subst.
      exists (ts' + t_oot).
      exact (@CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.eval_Construct_step_OOT
               nat src_fuel_res src_trace_res
    ...
    - intros ind npars mch brs rho dc vs body c r f1 f2 t1 t2
      ...
      + destruct (IHmch _ Hlt1) as [t_oot Hoot].
        exists t_oot. now eapply CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.eval_Case_step_OOT.
      + assert (Hlt2 : f' - f1 < f2) by lia.
        destruct (IHbody _ Hlt2) as [t_oot Hoot].
        exists (t1 + t_oot).
        assert (Heqf : f' = (f1 + (f' - f1))) by lia.
        rewrite Heqf.
        exact (@CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.eval_Case_step
                 nat src_fuel_res src_trace_res
                 Σ box_dc ind npars mch brs rho dc vs body c CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.OOT
                 f1 (f' - f1) t1 t_oot
                 Hmch Hdc Hfind Hoot).
    ...
    - intros p c rho vs v f1 t1 Hc IHc Hnth f' Hlt.
      ...
      exists t_oot. now eapply CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.eval_Proj_step_OOT.
    ...
    - intros rho e es v vs f fs t ts He IH_e Hes IH_es f' Hlt.
      ...
      + assert (Hlt_tl : f' - f < fs) by lia.
        ...
        * split.
          -- exact (@CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.eval_many_cons
                      nat src_fuel_res src_trace_res
    ...
    - intros rho e f Hlt0 f' Hlt.
      ...
      exact (@CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.eval_OOT
               nat src_fuel_res src_trace_res
    ...
    - intros rho e r f t Hstep IHstep f' Hlt.
      ...
      + assert (Hlt_step : f' - fuel_exp e < f) by lia.
        ...
        rewrite Heqf.
        exact (@CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.eval_step
                 nat src_fuel_res src_trace_res
                 Σ box_dc rho e CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.OOT (f' - fuel_exp e) t_oot Hoot).
  Qed.
  ...
  Lemma src_eval_val_oot_absurd rho0 e0 v0 f0 t_val t_oot :
    src_eval rho0 e0 (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val v0) f0 t_val ->
    src_eval rho0 e0 CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.OOT f0 t_oot ->
    False.
  Proof.
    intros Hval Hoot.
  ...
  Lemma src_eval_app_oot_body_if_fun_arg_val_no_body_val
    ...
    src_eval rho e1 (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Clos_v rho' na body)) f1 t1 ->
    src_eval rho e2 (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val v2) f2 t2 ->
    (forall src_v f' t',
        ~ src_eval (v2 :: rho') body (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val src_v) f' t') ->
    src_eval rho (EAst.tApp e1 e2) CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.OOT (f1 + f2 + f + 1) t ->
    exists t3, src_eval (v2 :: rho') body CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.OOT f t3.
  Proof.
    intros He1 He2 Hnoval Hoot_app.
    inversion Hoot_app; subst.
    - simpl in H. lia.
    - remember (EAst.tApp e1 e2) as e_app in H3.
      remember CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.OOT as r_oot in H3.
  ...
  Proof.
    ...
    - right. intros f.
      ...
      + exfalso.
        destruct Happ_val as [src_v [f_app [t_app Happ_val]]].
        destruct (@CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.src_eval_app_val_body
                    nat src_fuel_res src_trace_res
  ...
  Lemma src_eval_fixapp_oot_body_if_fun_arg_val_no_body_val
    ...
    src_eval rho e1 (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.ClosFix_v rho' mfix idx)) f1 t1 ->
    CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.fix_body mfix idx = Some (EAst.tLambda na body) ->
    src_eval rho e2 (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val v2) f2 t2 ->
    (forall src_v f' t',
        ~ src_eval (v2 :: CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.make_rec_env mfix rho') body
                   (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val src_v) f' t') ->
    src_eval rho (EAst.tApp e1 e2) CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.OOT (f1 + f2 + f + 1) t ->
    exists t3, src_eval (v2 :: CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.make_rec_env mfix rho') body CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.OOT f t3.
  Proof.
  ...
  Lemma src_not_stuck_fixapp_body rho e1 e2 rho' rho'' idx na mfix body v2 f1 t1 f2 t2 :
    src_eval rho e1 (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.ClosFix_v rho' mfix idx)) f1 t1 ->
    CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.fix_body mfix idx = Some (EAst.tLambda na body) ->
    CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.make_rec_env mfix rho' = rho'' ->
    src_eval rho e2 (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val v2) f2 t2 ->
    src_not_stuck rho (EAst.tApp e1 e2) ->
    src_not_stuck (v2 :: rho'') body.
  Proof.
    ...
    - right. intros f.
      ...
      + exfalso.
        destruct Happ_val as [src_v [f_app [t_app Happ_val]]].
        destruct (@CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.src_eval_fixapp_val_body
                    nat src_fuel_res src_trace_res
  ...
  Lemma src_eval_case_oot_mch_if_no_mch_val
    ...
    (forall src_v f' t', ~ src_eval rho mch (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val src_v) f' t') ->
    src_eval rho (EAst.tCase (ind, npars) mch brs) CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.OOT (S f) t ->
    exists t1, src_eval rho mch CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.OOT f t1.
  Proof.
    ...
    - match goal with
      | [ Hstep : @eval_env_step _ _ _ Σ box_dc rho
                     (EAst.tCase (ind, npars) mch brs) CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.OOT _ _ |- _ ] =>
          remember (EAst.tCase (ind, npars) mch brs) as e_case in Hstep;
          remember CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.OOT as r_oot in Hstep;
  ...
  Proof.
    intros Hns.
    destruct (classic (exists src_v f t, src_eval rho mch (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val src_v) f t))
      as [Hval | Hnoval].
    - left. exact Hval.
    - right. intros f.
      ...
      + exfalso.
        ...
        destruct (@CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.src_eval_case_val_scrut
                    nat src_fuel_res src_trace_res
  ...
  Lemma src_eval_case_oot_body_if_mch_val_no_body_val
    ...
    src_eval rho mch (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Con_v dc vs)) f1 t1 ->
    dc = dcon_of_con ind c ->
    find_branch ind c (List.length vs) brs = Some body ->
    (forall src_v f' t',
        ~ src_eval ((List.rev vs) ++ rho) body (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val src_v) f' t') ->
    src_eval rho (EAst.tCase (ind, npars) mch brs) CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.OOT (f1 + f + 1) t ->
    exists t2, src_eval ((List.rev vs) ++ rho) body CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.OOT f t2.
  Proof.
  ...
  Proof.
    ...
    - right. intros f.
      ...
      + exfalso.
        destruct Hcase_val as [src_v [f_case [t_case Hcase_val]]].
        destruct (@CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.src_eval_case_val_body
                    nat src_fuel_res src_trace_res
  ...
  Lemma src_eval_proj_oot_scrut_if_no_scrut_val rho p c f t :
    (forall src_v f' t', ~ src_eval rho c (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val src_v) f' t') ->
    src_eval rho (EAst.tProj p c) CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.OOT (S f) t ->
    exists t1, src_eval rho c CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.OOT f t1.
  Proof.
    ...
    - match goal with
      | [ Hstep : @eval_env_step _ _ _ Σ box_dc rho
                     (EAst.tProj p c) CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.OOT _ _ |- _ ] =>
  ...
  Proof.
    intros Hns.
    destruct (classic (exists src_v f t, src_eval rho c (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val src_v) f t))
      as [Hval | Hnoval].
    - left. exact Hval.
    - right. intros f.
      ...
      + exfalso.
        ...
        destruct (@CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.src_eval_proj_val_scrut
                    nat src_fuel_res src_trace_res
  ...
  Lemma src_eval_construct_oot_arg_if_prefix_val_no_arg_val
        (rho : CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.env) (ind : inductive) (c : nat)
        (args_done : list EAst.term) (e : EAst.term) (args_rest : list EAst.term)
        (vs_done : list CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.value) (fs ts f t : nat) :
    @CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.eval_fuel_many nat src_fuel_res src_trace_res
                             Σ box_dc rho args_done vs_done fs ts ->
    (forall src_v f' t', ~ src_eval rho e (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val src_v) f' t') ->
    src_eval rho (EAst.tConstruct ind c (args_done ++ e :: args_rest))
                 CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.OOT (fs + f + 1) t ->
    exists t_e, src_eval rho e CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.OOT f t_e.
  Proof.
    ...
    - remember (EAst.tConstruct ind c (args_done ++ e :: args_rest)) as e_con in H3.
      ...
      destruct H3; try discriminate;
        try match goal with
            | [ Hr : CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val _ = CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.OOT |- _ ] => discriminate
            end.
      ...
      + destruct Hearly as [prefix Hprefix].
        ...
        edestruct (@CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.eval_many_app_inv
                      nat src_fuel_res src_trace_res
        ...
        pose proof (@CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.eval_many_exact_det
                      nat src_fuel_res src_trace_res
  ...
  Lemma src_not_stuck_construct_arg
        (rho : CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.env) (ind : inductive) (c : nat)
        (args_done : list EAst.term) (e : EAst.term) (args_rest : list EAst.term)
        (vs_done : list CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.value) (fs ts : nat) :
    @CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.eval_fuel_many nat src_fuel_res src_trace_res
                             Σ box_dc rho args_done vs_done fs ts ->
  ...
  Proof.
    intros Hdone Hns.
    destruct (classic (exists src_v f t, src_eval rho e (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val src_v) f t))
      as [Hval | Hnoval].
    - left. exact Hval.
    - right. intros f.
      ...
      + exfalso.
        ...
        destruct (@CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.src_eval_construct_val_arg
                    nat src_fuel_res src_trace_res
  ...
  Definition anf_cvt_correct_oot_lower_bound_goal
             (vs : CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.env) (e : EAst.term) (f : nat) :=
      ...
      2:{
        ...
        2:{
          ...
          pose proof (anf_cvt_correct
                        ...
                        rho0 e0 (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val v0) f0 t0 Heval_e)
            as Hcorr_head.
               ...
               - assert (Hsub_k_S : S_k \subset S)
                 ...
                 + destruct (@anf_correct.anf_cvt_cmap_result_in_deps
                   ...
                   assert (Heval_body_e : exists f_ce t_ce,
                     src_eval [] body_x (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val v0) f_ce t_ce).
                   ...
                   assert (Heval_body_k : exists f_ck t_ck,
                     src_eval [] body_x (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val v_k0) f_ck t_ck).
                   { eapply anf_cvt_cmap_eval;
               ...
               - destruct (In_dec Pos.eq_dec x1 vnames) as [Hin_vn' | Hni_vn].
                 ...
                 + destruct (@anf_correct.anf_cvt_cmap_result_in_deps
                   ...
                   assert (Heval_body_j : exists f_cj t_cj,
                     src_eval [] body_x (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val v_j) f_cj t_cj).
                   { eapply anf_cvt_cmap_eval;
  ...
  Lemma anf_cvt_correct_val_cont
    ...
    anf_cvt_rel' S e vnames S' C x ->
    Disjoint _ (occurs_free e_k) ((S \\ S') \\ [set x]) ->
    src_eval vs e (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val v) f t ->
    anf_val_rel' v v' ->
    preord_exp cenv (anf_bound f t) eq_fuel i
  ...
  Proof.
    ...
    pose proof (anf_cvt_correct
                  ...
                  dcon_to_tag_inj box_dc box_tag cenv_case_consistent
                  Hcmap_eval_coherent Hglob_term Hglob_fuel_zero Hglob_wf val_rel_exists
                  vs e (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val v) f t Heval)
      as Hcorr.
  ...
  Lemma anf_cvt_correct_val_implies_target_oot
    ...
    global_env_rel' (kn_deps e) rho ->
    anf_cvt_rel' S e vnames S' C x ->
    src_eval vs e (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val v) f_val t_val ->
    anf_val_rel' v v' ->
    exists cout,
  ...
  Lemma anf_cvt_correct_oot_from_source_value
    ...
    global_env_rel' (kn_deps e) rho ->
    anf_cvt_rel' S e vnames S' C x ->
    src_eval vs e CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.OOT f_oot t_oot ->
    src_eval vs e (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val v) f_val t_val ->
    exists cout,
      bstep_fuel cenv rho (C |[ Ehalt x ]|) f_oot eval.OOT cout.
  Proof.
  ...
  Lemma anf_cvt_correct_oot_lower_bound_goal_if_value
        vs e f_oot t_oot :
    src_eval vs e CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.OOT f_oot t_oot ->
    (exists v f_val t_val, src_eval vs e (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val v) f_val t_val) ->
  ...
  Lemma anf_cvt_correct_oot_lower_bound
        vs e f t :
    src_eval vs e CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.OOT f t ->
    anf_cvt_correct_oot_lower_bound_goal vs e f.
  Proof.
    intros Hoot_init.
    set (P := fun p : nat * EAst.term =>
      forall vs0 t0,
        src_eval vs0 (snd p) CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.OOT (fst p) t0 ->
    ...
    { refine (well_founded_induction_type div_lt_wf P _).
      ...
      intros rho vnames C x S S'
             Hwf Hwfe Hcons Hcmap Hdis Hdis_cmap Henv Hglob Hrel
             e_k Hdis_ek Hns.
      unfold src_not_stuck, CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.not_stuck in Hns.
      ...
      - remember (snd (f0, e0)) as e_cur in H.
        remember CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.OOT as r_cur in H.
        ...
        + (* eval_App_step *)
          ...
          assert (Hwf_clos : well_formed_val Σ (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Clos_v rho_clos na_clos body_clos)).
          ...
          { eapply eval_preserves_wf; [exact Hglob_wf | exact Hwf | | exact Heval2].
            ...
            rewrite Henv_len.
            exact Hwfe2. }
          destruct (val_rel_exists (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Clos_v rho_clos na_clos body_clos) Hwf_clos)
            as [v1' Hrel_clos].
          ...
          { eapply anf_env_rel_set; [exact Henv |].
            intros k Hk.
            assert (Hek : nth_error rho0 k = Some (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Clos_v rho_clos na_clos body_clos)).
            { change positive with var in Hk.
              eapply anf_cvt_rel_var_lookup;
                [exact Heval1 | exact Hcvt_e1
                | exact Hdis | exact Hdis_cmap | exact Hcons | exact Hcmap | exact Hk]. }
            exists (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Clos_v rho_clos na_clos body_clos). split; [exact Hek | exact Hrel_clos]. }
          ...
          { eapply global_env_rel_set; [exact Hglob_e2_base |].
            ...
            destruct (anf_cvt_cmap_eval rho0 e1 (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Clos_v rho_clos na_clos body_clos)
          ...
          * subst x2.
              ...
              - destruct (@anf_cvt_result_in_consumed
                ...
                + destruct (@anf_cvt_cmap_result_in_deps
                  ...
                  assert (Heval1_cmap : exists f_c t_c,
                    src_eval [] body_g (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val (Clos_v rho_clos na_clos body_clos)) f_c t_c).
                  { eapply anf_cvt_cmap_eval;
                      [exact Heval1 | exact Hcvt_e1 | exact Hdis | exact Hdis_cmap
                  ...
                  assert (Heval2_cmap : exists f_c t_c,
                    src_eval [] body_g (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val varg) f_c t_c).
                  { eapply anf_cvt_cmap_eval;
                      [exact Heval2 | exact Hcvt_e2
                      | eapply Disjoint_Included_r;
                          [eapply anf_cvt_exp_subset; exact Hcvt_e1 | exact Hdis]
            ...
            destruct (anf_cvt_correct_val_cont_oot
              ...
              as [c2 [Hlb2 Hoot2]].
            destruct (anf_cvt_correct_val_cont_oot
                        rho0 e1 (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Clos_v rho_clos na_clos body_clos) f1_app t1_app
        ...
        + (* eval_FixApp_step *)
          ...
          assert (Hwfe2 : wellformed Σ (Datatypes.length vnames) e2 = true).
          { eapply proj2. eapply wellformed_tApp. exact Hwfe. }
          assert (Hwf_fix : well_formed_val Σ (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.ClosFix_v rho' mfix idx)).
          { eapply eval_preserves_wf; [exact Hglob_wf | exact Hwf | | exact H].
            pose proof Henv as Henv_len.
            unfold anf_env_rel' in Henv_len.
            apply Forall2_length in Henv_len.
          ...
          { eapply eval_preserves_wf; [exact Hglob_wf | exact Hwf | | exact H2].
            ...
            rewrite Henv_len.
            exact Hwfe2. }
          destruct (val_rel_exists (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.ClosFix_v rho' mfix idx) Hwf_fix)
            as [fix_v' Hrel_fix].
          ...
          { eapply anf_env_rel_set; [exact Henv |].
            intros k Hk.
            assert (Hek : nth_error rho0 k = Some (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.ClosFix_v rho' mfix idx)).
            { change positive with var in Hk.
              eapply anf_cvt_rel_var_lookup;
                [exact H | exact Hcvt_e1
                | exact Hdis | exact Hdis_cmap | exact Hcons | exact Hcmap | exact Hk]. }
            exists (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.ClosFix_v rho' mfix idx).
          ...
          { eapply global_env_rel_set; [exact Hglob_e2_base |].
            ...
            assert (Heval_g' : exists fg tg,
              src_eval [] body_g (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.ClosFix_v rho' mfix idx)) fg tg).
            { eapply anf_cvt_cmap_eval;
          ...
          { eapply Disjoint_Included_r;
              [eapply anf_cvt_exp_subset; eassumption | exact Hdis_cmap]. }
          unfold CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.fix_body in H0.
          ...
          { rewrite length_app, length_rev.
            ...
            exact (proj2 Hwf_bod). }
          assert (Hwf_body_env : well_formed_env Σ (v2 :: CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.make_rec_env mfix rho')).
          { constructor; [exact Hwf_v2 |].
            inversion Hwf_fix as [| | ? ? ? Hwf_rho' Hidx_bound Hwf_mfix_bodies].
            subst.
          ...
          assert (Hcons_body :
            env_consistent (x_pc :: List.rev fnames ++ names)
                           (v2 :: CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.make_rec_env mfix rho')).
          { eapply (env_consistent_extend_fresh
                      x_pc (List.rev fnames ++ names) v2
                      (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.make_rec_env mfix rho')).
          ...
          assert (Henv_body :
            anf_env_rel' (x_pc :: List.rev fnames ++ names)
                         (v2 :: CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.make_rec_env mfix rho') rho_bc).
          { unfold rho_bc.
            constructor.
            - exists v2'. split; [rewrite M.gss; reflexivity | exact Hrel_v2].
            - eapply anf_env_rel_weaken.
          ...
          assert (Hfix_body :
            CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.fix_body mfix idx = Some (EAst.tLambda na body)).
          { unfold CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.fix_body. rewrite Hnth_d. now rewrite Hbody_eq. }
          assert (Hns_body :
            src_not_stuck (v2 :: CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.make_rec_env mfix rho') body).
          { eapply src_not_stuck_fixapp_body
                      with (rho := rho0) (e1 := e1) (e2 := e2)
                           (rho' := rho')
                           (rho'' := CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.make_rec_env mfix rho')
          ...
          pose proof (IH (f3, body) Hlt_body
                         (v2 :: CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.make_rec_env mfix rho') t3 H4) as IHbody.
          unfold anf_cvt_correct_oot_lower_bound_goal in IHbody.
          ...
          * subst x2.
            assert (Hrel_rho_ex : exists v_rho,
              M.get x1 rho = Some v_rho /\
              anf_val_rel' (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.ClosFix_v rho' mfix idx) v_rho /\
              anf_val_rel' v2 v_rho /\
              CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.ClosFix_v rho' mfix idx = v2).
            { destruct (In_dec Pos.eq_dec x1 vnames) as [Hin_vn | Hni_vn].
              - apply In_nth_error in Hin_vn. destruct Hin_vn as [k0 Hk0].
                assert (Heval1_k : nth_error rho0 k0 = Some (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.ClosFix_v rho' mfix idx)).
                { eapply anf_cvt_rel_var_lookup;
                    [exact H | exact Hcvt_e1 | exact Hdis | exact Hdis_cmap
                    | exact Hcons | exact Hcmap | exact Hk0]. }
                ...
                assert (v_src = CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.ClosFix_v rho' mfix idx) by congruence.
                subst v_src.
                assert (Heq_v2 : CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.ClosFix_v rho' mfix idx = v2) by congruence.
              ...
              - destruct (@anf_cvt_result_in_consumed
                ...
                + destruct (@anf_cvt_cmap_result_in_deps
                  ...
                  exists v_rho. split; [exact Hget_g |].
                  assert (Heval1_cmap : exists f_c t_c,
                    src_eval [] body_g (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.ClosFix_v rho' mfix idx)) f_c t_c).
                  { eapply anf_cvt_cmap_eval;
                      [exact H | exact Hcvt_e1 | exact Hdis | exact Hdis_cmap
                      | exact Hcons | exact Hcmap | exact Hlk1 | exact Hdecl_g | exact Hbody_g]. }
                  destruct Heval1_cmap as [f_c1 [t_c1 Hev1]].
                  assert (Heval2_cmap : exists f_c t_c,
                    src_eval [] body_g (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val v2) f_c t_c).
                  { eapply anf_cvt_cmap_eval;
                      [exact H2 | exact Hcvt_e2
                      | eapply Disjoint_Included_r;
                          [eapply anf_cvt_exp_subset; exact Hcvt_e1 | exact Hdis]
            ...
            destruct (anf_cvt_correct_val_cont_oot
              ...
              as [c2 [Hlb2 Hoot2]].
            destruct (anf_cvt_correct_val_cont_oot
                        rho0 e1 (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.ClosFix_v rho' mfix idx) f1 t1
                        rho vnames C1 x1 S S2 c2
                        (C2 |[ Eletapp x x1 func_tag [x1] e_k ]|)
                        (Vfun rho1 Bs f4) c2
                        (le_n _)
        ...
        + (* eval_LetIn_step *)
          ...
          { destruct (classic (exists (src_v : CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.value) (f' : nat) (t' : nat),
                          src_eval (v1 :: rho0) t0 (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val src_v) f' t'))
              as [Hval_t | Hnoval_t].
            - left. exact Hval_t.
            - right. intros f'.
              ...
              + remember (EAst.tLetIn na b t0) as e_let in H6.
                remember CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.OOT as r_oot in H6.
                destruct H6; try discriminate.
                * injection Heqe_let as <- <- <-.
                  assert (Heq_bind : v1 = v0 /\ f1 = f3 /\ t1 = t4)
                    by (eapply (@CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.eval_val_exact_det
                                  nat
        ...
        + (* eval_LetIn_step_OOT *)
          ...
          { destruct (classic (exists (src_v : CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.value) (f' : nat) (t' : nat),
                        src_eval rho0 b (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Val src_v) f' t'))
              as [Hval_b | Hnoval_b].
            - left. exact Hval_b.
            - right. intros f'.
              ...
              + remember (EAst.tLetIn na b t0) as e_let in H0.
                remember CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.OOT as r_oot in H0.
        ...
        + (* eval_Case_step *)
          ...
          { exact (@anf_env_rel_length func_tag default_tag tgm cmap Σ box_dc box_tag
                                       _ _ _ Henv). }
          assert (Hwf_con : well_formed_val Σ (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Con_v (dcon_of_con ind c) vs0)).
          { eapply eval_preserves_wf; [exact Hglob_wf | exact Hwf | | exact H].
            rewrite Hlen_env. exact Hwfe_mch. }
          destruct (val_rel_exists (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Con_v (dcon_of_con ind c) vs0) Hwf_con)
            as [v_con Hcon_rel_saved].
          remember (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Con_v (dcon_of_con ind c) vs0) as cv in Hcon_rel_saved.
          ...
          set (c_tag := dcon_to_tag default_tag (dcon_of_con ind c) tgm) in *.
          assert (Hcon_rel : anf_val_rel' (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Con_v (dcon_of_con ind c) vs0)
          ...
          { pose proof
            ...
            exact Hbsf. }
          destruct (anf_cvt_correct_val_cont_oot
                      rho0 mch (CertiRocq.LambdaBox_to_LambdaANF.fuel_sem.Con_v (dcon_of_con ind c) vs0) f1 t1
