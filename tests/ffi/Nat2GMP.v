...
CertiRocq Eval --allow-unsafe-erasure --time --debug test_gmp.
...
CertiRocq Show IR --allow-unsafe-erasure --debug testzi.
CertiRocq Eval --allow-unsafe-erasure --debug testzi.
...
CertiRocq Show IR --allow-unsafe-erasure --typed-erasure --debug testzi2.
CertiRocq Eval --allow-unsafe-erasure --typed-erasure --debug testzi2.
...
CertiRocq Show IR --allow-unsafe-erasure --typed-erasure --debug testzib.
CertiRocq Eval --allow-unsafe-erasure --typed-erasure --debug testzib.
...
CertiRocq Show IR --allow-unsafe-erasure --typed-erasure --debug test_add_override.
CertiRocq Eval --allow-unsafe-erasure --typed-erasure --debug --time test_add_override.
